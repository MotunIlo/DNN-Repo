...
st.markdown("<h4 style = 'margin: -30px; color: #280274; text-align: center; font-family: Copperplate Gothic'> Built by ILO MOTUNRAYO </h4>", unsafe_allow_html = True)
...
with robot_image:
    robot_image.image('pngwing.com (1).png',width = 500, caption = 'I reply all your questions')
...
thread = threading.Thread(target=speak, args=(text_to_speak))
thread.start()
